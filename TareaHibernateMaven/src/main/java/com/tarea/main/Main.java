...
static SessionFactory sessionFactory = new MetadataSources( registry ).buildMetadata().buildSessionFactory();
	...
	public static void main(String[] args) {
		
		 {
			    ...
			    Persona persona1 = new Persona (0,"Damarys");
			    Persona persona2 = new Persona (0,"Emily");
			    Persona persona3 = new Persona (0,"Jessenia");
                ...
                Skill skill1 = new Skill (0,"Cocinar");
                Skill skill2 = new Skill (0,"Maquillar");
                Skill skill3 = new Skill (0,"Nadar");
                Skill skill4 = new Skill (0,"Cantar");
